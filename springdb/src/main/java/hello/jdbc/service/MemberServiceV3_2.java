...
public class MemberServiceV3_2 {
    ...
    public MemberServiceV3_2(PlatformTransactionManager transactionManager, MemberRepositoryV3 memberRepository) {
        ...
        /**
         * transactionTemplate은 그냥 클래스라 유연성이 떨어져서 이런식으로 주입받도록 함 (관례)
         */
    ...
    public void accountTransfer(String fromId, String toId, int money) throws SQLException {
        ...
        /**
         트랜잭션 템플릿이 트랜잭션 매니저 가지고 있다 -> 템플릿 안에서 매니저 로직도 실행
         템플릿만 작성하면 비즈니스 로직만 수행할 수 있다.
         근데 아직도 서비스에 트랜잭션 처리하는 로직 (트랜잭션 템플릿을 사용한다...)이 있다. -> 비즈니스가 핵심이고 템플릿은 그냥 부가기능 아닌교 -> AOP 써먹자
         */
